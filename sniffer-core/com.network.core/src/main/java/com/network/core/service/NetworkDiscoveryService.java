...
//        initiallyWrappedInterfaces = determineBoundNetworkInterfaces();
        PcapNetworkInterfaceWrapper wrapper = new PcapNetworkInterfaceWrapper(Pcaps.getDevByName("en0"));
        startPacketCapture(wrapper);
//        initiallyWrappedInterfaces = Set.of(wrapper);
